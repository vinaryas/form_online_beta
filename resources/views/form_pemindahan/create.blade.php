...
<form class="card" action="" method="POST">
    ...
    <div  class="card-body">
        <div class="float-left">
            <a href="{{ route('form-pemindahan.index') }}" class="btn btn-info"><i class="fas fa-arrow-left"></i> Batal </a>
        </div>
    ...
    <input type="hidden" value="{{ $form->id }}" name="user_id" id="user_id">
    <div class="card-footer">
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <label>NIK</label>
                <input type="text" value="{{ $form->username }}" id="nik"name="nik" class="form-control" readonly>
            </div>
            <div class="col-md-6">
                <label>Region</label>
                <select name="region_id" id="region_id" class="form-control" readonly>
                    <option value="{{ $form->region_id }}">{{ $form->region->name }}</option>
                </select>
            </div>
            <div class="col-md-6">
                <label>Store</label>
                <select name="store_id" id="store_id" class="form-control" readonly>
                    <option value="{{ $form->store_id }}">{{ $form->stores }}</option>
                </select>
            </div>
        </div>
